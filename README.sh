...
'
_paragraph_begin
_t 'Template credentials records for an individual user are provided as text files under the &#39;self&#39; directory.
...
_paragraph_end
_heading1 'Examples'
_t 'This repository itself is an example.'
_t '
...
_heading1 'Design'
_paragraph_begin
_t 'Self-modifying credManager scripts generate text/shell, and HTML to PDF, output.'
_paragraph_end
_t '
...
_heading1 'Safety'
_paragraph_begin
_t 'Strong 2FA is now necessary. Do NOT trust recovery codes . Do NOT trust TOPT . Do NOT trust passwords. Do NOT trust non-standalone (ie. other than YubiKey Bio) platform keys.
